...
df_faucet = pd.read_csv('/home/oscar/Github/arbisepolia_scan/output_data/txlistinternal_celo2.csv',
                        index_col=False)
...
for address in df_faucet['to']:
    print(address)
    try:
        temp_resp = cc.CeloAlfScanner(key=KEY).transaction_address(address=address)
    except:
        temp_resp = {
                      "status": "1",
                      "message": "OK",
...
df_result.to_csv('/home/oscar/Github/arbisepolia_scan/output_data/txlistaddres_celo2.csv')
