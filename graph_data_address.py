...
df_faucet = pd.read_csv('/home/oscar/Github/arbisepolia_scan/output_data/txlistinternal3.csv',
                        index_col=False)
...
df_result.to_csv('/home/oscar/Github/arbisepolia_scan/output_data/txlistaddres3.csv')
